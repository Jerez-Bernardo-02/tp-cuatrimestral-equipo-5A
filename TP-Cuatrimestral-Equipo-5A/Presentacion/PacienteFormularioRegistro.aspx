<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PacienteFormularioRegistro.aspx.cs" Inherits="Presentacion.FormularioRegistro" UnobtrusiveValidationMode="None"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4">
        ...
        <div class="mb-3">
            ...
            <asp:CustomValidator ID="cvFechaNacimiento" runat="server" ControlToValidate="TextFechaNacimiento" ErrorMessage="La fecha de nacimiento no puede ser futura."  ForeColor="Red" OnServerValidate="cvFechaNacimiento_ServerValidate" Display="Dynamic" />
       </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
               ...
               <div class="col-12 mt-2">
                    <asp:CustomValidator ID="cvEmailDni" runat="server" ErrorMessage="El email o DNI ya están registrados." ForeColor="Red" OnServerValidate="cvEmailDni_ServerValidate" Display="Dynamic" />
               </div>
 
            <div class="col-md-6">
                <label for="txtTelefono" class="form-label">Teléfono</label>
                <asp:TextBox runat="server" ID="txtTelefono" CssClass="form-control" placeholder="Teléfono"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvTelefono" runat="server" ControlToValidate="txtTelefono"  ErrorMessage="El teléfono es obligatorio."  ForeColor="Red" />
                <asp:RegularExpressionValidator ID="revTelefono" runat="server"  ControlToValidate="txtTelefono"  ErrorMessage="El teléfono debe tener 10 números." ValidationExpression="^\d{10}$" ForeColor="Red" />
            </div>
        </div>
         <div class="row mb-3">
