<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdministrador.Master" AutoEventWireup="true" CodeBehind="MenuAdministrador.aspx.cs" Inherits="Presentacion.MenuAdministrador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid">
        <div class="row">
            <!-- Columna izquierda -->
            <div class="col-md-4">
                <h3 class="mb-3 mt-3">Gestión de Médicos</h3>

                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body">
                        <asp:TextBox ID="txtBuscarMedicos" runat="server"
                                     CssClass="form-control"
                                     placeholder="Buscar por nombre o Matrícula..."></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="list-group shadow-sm">
                    <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                            <strong class="mb-0">Médico 1</strong>
                            <p class="mb-0 small text-muted">Mat.: ********</p>
                        </div>
                        <i class="bi bi-pencil text-primary" style="font-size:1.2rem; cursor:pointer;"></i>
                    </a>

                    <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                            <strong class="mb-0">Médico 2</strong>
                            <p class="mb-0 small text-muted">Mat.: ********</p>
                        </div>
                        <i class="bi bi-pencil text-primary" style="font-size:1.2rem; cursor:pointer;"></i>
                    </a>
                    ...
                    <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                            <strong class="mb-0">Médico 3</strong>
                            <p class="mb-0 small text-muted">Mat.: ********</p>
                        </div>
                        <i class="bi bi-pencil text-primary" style="font-size:1.2rem; cursor:pointer;"></i>
                    </a>
            ...
            <div class="col-md-8">
                <div class="container mt-5">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <asp:Button Text="Crear Medico" ID="BtnCrearUsuario" OnClick="BtnCrearUsuario_Click" runat="server" class="btn btn-primary" />
                    </div>
