<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdministradorPacientes.aspx.cs" Inherits="Presentacion.AdministradorPacientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4">

        <h3 class="fw-bold mb-4">Pacientes </h3>

        <div class="card shadow-sm">
            <div class="card-body">
                <asp:GridView runat="server" ID="dgvPacientes" DataKeyNames="Id" AutoGenerateColumns="False" CssClass="table table-striped"  OnSelectedIndexChanged="dgvPacientes_SelectedIndexChanged">
                     <Columns>
