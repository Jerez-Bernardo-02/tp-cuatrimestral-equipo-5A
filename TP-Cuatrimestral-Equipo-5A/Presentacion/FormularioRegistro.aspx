...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-3">
                <asp:DropDownList ID="ddlTipoPermiso" runat="server" AutoPostBack="true" CssClass="btn btn-outline border dropdown-toggle" OnSelectedIndexChanged="ddlTipoPermiso_SelectedIndexChanged" Visible="false"></asp:DropDownList>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="txtNombre" ErrorMessage="Solo puede contener letras." ValidationExpression="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$" ForeColor="Red" />
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="txtApellido" ErrorMessage="Solo puede contener letras." ValidationExpression="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$" ForeColor="Red" />
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <asp:CustomValidator ID="cvFechaNacimiento" runat="server" ControlToValidate="txtFechaNacimiento" ErrorMessage="La fecha de nacimiento no puede ser futura." ForeColor="Red" Display="Dynamic" OnServerValidate="cvFechaNacimiento_ServerValidate"/>
        ...
        <asp:Panel ID="pnlUsuario" runat="server">
            ...
            <h4 class="text-primary mb-4">Datos de acceso</h4>
            <div class="row mb-3">
                <div class="col-md-6">
