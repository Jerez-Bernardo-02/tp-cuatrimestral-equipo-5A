...
namespace Negocio
{
    public class EmailService
    {
        ...
        public EmailService()
        {
            ...
            server.Credentials = new NetworkCredential("testingprogramacionutnfrpg@gmail.com", "dzbc foje eglf kqzw"); // gmail creado para el programa, clave generada para esta app
